...
Shader "shd_Terrain"
{
	Properties
	{
		...
		_Texture2NormalMap1("Texture 2 Normal Map", 2D) = "bump" {}
		_Texture2("Texture 1", 2D) = "white" {}
		_Texture1NormalMap1("Texture 1 Normal Map", 2D) = "bump" {}
		_Metallic1("Metallic", Range( 0 , 1)) = 0
		_Smoothness1("Smoothness", Range( 0 , 1)) = 0
		_NormalMap1Strength1("Normal Map 1 Strength", Float) = 1
		[ASEEnd]_NormalMap2Strength1("Normal Map 2 Strength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Texture2_ST;
			float4 _Texture3_ST;
			float4 _Texture1NormalMap1_ST;
			float4 _Texture2NormalMap1_ST;
			float _NormalMap1Strength1;
			float _NormalMap2Strength1;
			float _Metallic1;
			float _Smoothness1;
			...
			sampler2D _Texture2;
			sampler2D _Texture3;
			sampler2D _Texture1NormalMap1;
			sampler2D _Texture2NormalMap1;
						...
						)
			{
				...
				float2 uv_Texture2 = packedInput.ase_texcoord5.xy * _Texture2_ST.xy + _Texture2_ST.zw;
				float2 uv_Texture3 = packedInput.ase_texcoord5.xy * _Texture3_ST.xy + _Texture3_ST.zw;
				float4 lerpResult19 = lerp( tex2D( _Texture2, uv_Texture2 ) , tex2D( _Texture3, uv_Texture3 ) , packedInput.ase_color.r);
				
				float2 uv_Texture1NormalMap1 = packedInput.ase_texcoord5.xy * _Texture1NormalMap1_ST.xy + _Texture1NormalMap1_ST.zw;
				float2 uv_Texture2NormalMap1 = packedInput.ase_texcoord5.xy * _Texture2NormalMap1_ST.xy + _Texture2NormalMap1_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _Texture1NormalMap1, uv_Texture1NormalMap1 ), 1.0f ) * _NormalMap1Strength1 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap1, uv_Texture2NormalMap1 ), 1.0f ) * _NormalMap2Strength1 ) , packedInput.ase_color.r);
				float3 normalizeResult22 = normalize( lerpResult21 );
				
				surfaceDescription.Albedo = lerpResult19.rgb;
				surfaceDescription.Normal = normalizeResult22;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Texture2 = packedInput.ase_texcoord.xy * _Texture2_ST.xy + _Texture2_ST.zw;
				float2 uv_Texture3 = packedInput.ase_texcoord.xy * _Texture3_ST.xy + _Texture3_ST.zw;
				float4 lerpResult19 = lerp( tex2D( _Texture2, uv_Texture2 ) , tex2D( _Texture3, uv_Texture3 ) , packedInput.ase_color.r);
				
				float2 uv_Texture1NormalMap1 = packedInput.ase_texcoord.xy * _Texture1NormalMap1_ST.xy + _Texture1NormalMap1_ST.zw;
				float2 uv_Texture2NormalMap1 = packedInput.ase_texcoord.xy * _Texture2NormalMap1_ST.xy + _Texture2NormalMap1_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _Texture1NormalMap1, uv_Texture1NormalMap1 ), 1.0f ) * _NormalMap1Strength1 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap1, uv_Texture2NormalMap1 ), 1.0f ) * _NormalMap2Strength1 ) , packedInput.ase_color.r);
				float3 normalizeResult22 = normalize( lerpResult21 );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Texture1NormalMap1 = packedInput.ase_texcoord3.xy * _Texture1NormalMap1_ST.xy + _Texture1NormalMap1_ST.zw;
				float2 uv_Texture2NormalMap1 = packedInput.ase_texcoord3.xy * _Texture2NormalMap1_ST.xy + _Texture2NormalMap1_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _Texture1NormalMap1, uv_Texture1NormalMap1 ), 1.0f ) * _NormalMap1Strength1 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap1, uv_Texture2NormalMap1 ), 1.0f ) * _NormalMap2Strength1 ) , packedInput.ase_color.r);
				float3 normalizeResult22 = normalize( lerpResult21 );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Texture2 = packedInput.ase_texcoord7.xy * _Texture2_ST.xy + _Texture2_ST.zw;
				float2 uv_Texture3 = packedInput.ase_texcoord7.xy * _Texture3_ST.xy + _Texture3_ST.zw;
				float4 lerpResult19 = lerp( tex2D( _Texture2, uv_Texture2 ) , tex2D( _Texture3, uv_Texture3 ) , packedInput.ase_color.r);
				
				float2 uv_Texture1NormalMap1 = packedInput.ase_texcoord7.xy * _Texture1NormalMap1_ST.xy + _Texture1NormalMap1_ST.zw;
				float2 uv_Texture2NormalMap1 = packedInput.ase_texcoord7.xy * _Texture2NormalMap1_ST.xy + _Texture2NormalMap1_ST.zw;
				float3 lerpResult21 = lerp( ( UnpackNormalScale( tex2D( _Texture1NormalMap1, uv_Texture1NormalMap1 ), 1.0f ) * _NormalMap1Strength1 ) , ( UnpackNormalScale( tex2D( _Texture2NormalMap1, uv_Texture2NormalMap1 ), 1.0f ) * _NormalMap2Strength1 ) , packedInput.ase_color.r);
				float3 normalizeResult22 = normalize( lerpResult21 );
...
/*ASEBEGIN
Version=18912
6.4;11.2;1523.2;791.8;1526.69;421.045;1.667249;True;False
Node;AmplifyShaderEditor.SamplerNode;10;-1721.526,107.1204;Inherit;True;Property;_Texture1NormalMap1;Texture 1 Normal Map;3;0;Create;True;0;0;0;False;0;False;-1;30ec70ef60a2bb54ea2df6f72c77bdc6;19122873fde8ac946953306cc0ad4937;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;9;-1661.668,308.2014;Inherit;False;Property;_NormalMap1Strength1;Normal Map 1 Strength;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-1762.162,409.8008;Inherit;True;Property;_Texture2NormalMap1;Texture 2 Normal Map;1;0;Create;True;0;0;0;False;0;False;-1;6c41a2cea80b4fc499bac2a6c14a4514;0ce960630660f47488fb2301d55907b0;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-1643.192,625.7219;Inherit;False;Property;_NormalMap2Strength1;Normal Map 2 Strength;7;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;15;-1406.188,437.7851;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-1353.901,55.16876;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.VertexColorNode;13;-1318.263,599.4373;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;17;-1713.904,-282.5423;Inherit;True;Property;_Texture3;Texture 2;0;0;Create;True;0;0;0;False;0;False;-1;6c41a2cea80b4fc499bac2a6c14a4514;8cedb6a9a85cf874e868f90e5045c3f6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;16;-1722.066,-519.1188;Inherit;True;Property;_Texture2;Texture 1;2;0;Create;True;0;0;0;False;0;False;-1;30ec70ef60a2bb54ea2df6f72c77bdc6;30ec70ef60a2bb54ea2df6f72c77bdc6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;12;-1606.383,-98.17123;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;21;-1126.805,64.90997;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;19;-1221.54,-317.0425;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-628.6326,220.9217;Inherit;False;Property;_Smoothness1;Smoothness;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-653.1832,122.9664;Inherit;False;Property;_Metallic1;Metallic;4;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;22;-891.8344,63.78038;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;23;0,0;Float;False;True;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;4;shd_Terrain;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-27;False;False;False;False;False;False;False;False;False;True;True;0;True;-14;255;False;-1;255;True;-13;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;True;0;True;-15;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;42;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Receive SSR Transparent;0;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
...
WireConnection;19;2;12;1
WireConnection;22;0;21;0
WireConnection;23;0;19;0
WireConnection;23;1;22;0
WireConnection;23;4;20;0
WireConnection;23;7;18;0
ASEEND*/
//CHKSM=2F77593E4CFA95B34D84A98644F85ED7C44863D3